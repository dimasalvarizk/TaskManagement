...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-56 h-screen bg-slate-50/70 dark:bg-[#111318] border-r border-slate-200 dark:border-slate-800 flex flex-col justify-between select-none z-20 shrink-0 transition-colors">
      <div>
        {/* Brand Header */}
        ...
        {!isViewer && (
          <div className="p-2.5">
            <button
              ...
              className="w-full py-1.5 px-3 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white font-medium text-xs flex items-center justify-center gap-1.5 transition-colors shadow-xs"
            >
      ...
      <div className="p-2.5 border-t border-slate-200 dark:border-slate-800">
        <div className="flex items-center justify-between p-1.5 rounded-lg hover:bg-slate-200/40 dark:hover:bg-slate-800/50 transition-colors">
          ...
          <button
            ...
            className="p-1 rounded text-slate-400 hover:text-red-600 dark:hover:text-red-400 hover:bg-slate-200/60 dark:hover:bg-slate-700/50 transition-colors shrink-0"
            title="Log Out"
          >
